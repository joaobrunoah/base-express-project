...
module.exports = {
  ...
  INCORRECT_PARAMETERS: new ApiError(400, 'Incorrect value for parameters: One or more parameters does not exist'),
  INVALID_EMAIL: new ApiError(400, 'E-mail is not valid'),
  INVALID_PASSWORD: new ApiError(400, 'Password is not valid'),
  INVALID_SIMULATION_TOKEN: new ApiError(401, 'Simulation Token is not valid'),
  ...
  PASSWORD_NOT_MATCH: new ApiError(400, 'Password and Confirm Password are different.'),
  ...
  UNAUTHORIZED: new ApiError(401, 'No login token was passed'),
